    ...
    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
      ...
      <div className="mt-8 border-t dark:border-gray-700 pt-6">
        ...
        <form onSubmit={handleAddUser} className="flex items-center space-x-2 mb-4">
          ...
          />
          <button type="submit" disabled={isSubmitting} className="px-4 py-2 bg-secondary text-white rounded-md hover:bg-secondary-hover transition-colors disabled:bg-gray-400">
            {isSubmitting ? '追加中...' : '追加'}
          </button>
        </form>
